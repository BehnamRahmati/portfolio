...
const Footer: React.FC<IFooter> = () => {
	...
	return <footer className={styles.footer}>
		...
		<div className='px-5 2xl:px-0 py-10 lg:pt-24'>
			<div className="py-5 border-t-2 border-t-white flex flex-col-reverse space-y-10 space-y-reverse md:space-y-0 md:flex-row items-center justify-between container mx-auto">
				...
				<div className='flex flex-row items-end ltr space-x-4'>
					<p className="capitalize text-sm lg:text-base font-bold leading-8 text-center">designed <span className="text-xl text-violet-700 font-bold leading-8">&</span>  developed <span className='text-4xl text-violet-700'>.</span> by behnam rahmati</p>
				</div>
