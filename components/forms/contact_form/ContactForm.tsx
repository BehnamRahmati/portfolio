...
const ContactForm: React.FC<IContactForm> = ({
	...
	return <div className="h-full" >
		<form  className="flex flex-col h-full">
			...
			<button type={"submit"} className="w-full bg-violet-500 p-4 text-lg capitalize text-center mt-24 lg:mt-auto lg:mb-0 rounded-lg transition-all delay-75 ease-in-out transform hover:scale-105">send</button>
		</form>
	</div>;
};
